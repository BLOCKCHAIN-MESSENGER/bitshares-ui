...
import TDexGatewayDepositRequest from "./TDexGatewayDepositRequest";
...
class TDexGateway extends React.Component {
    constructor(props) {
        super();

        this.state = {
            activeCoin: this._getActiveCoin(props, {action: "deposit"}),
            action: props.viewSettings.get(`tdexAction`, "deposit")
        };
    }

    _getActiveCoin(props, state) {
        let cachedCoin = props.viewSettings.get(`activeCoin_tdex_${state.action}`, null);
    ...
    render() {
        ...
        let supportUrl = "https://tdex.freshdesk.com";
                ...
                {!coin ? null :
                    <div>
                        ...
                        <div style={{marginBottom: 15}}>
                            ...
                            <div><Translate content="gateway.tdex.support_block" /><br /><br /><a href={supportUrl}>{supportUrl}</a></div>
                        </div>
...
export default connect(TDexGateway, {
    listenTo() {
